 ...
 * Google Sitemaps
 *
 * Class that handles building every sort of Google Sitemap including sitemap
 * indexes
 *
 * @author Chris Nasr
 ...
 *
 * Allows you to easily create large sitemaps with more than 50k of records.
 *
 * @name GoogleSitemaps
 */
class GoogleSitemaps
{
	 ...
	 * Constructor
	 *
	 * Initialise the instance of GoogleSitemaps
	 *
	 * @name GoogleSitemaps
	 * @access public
